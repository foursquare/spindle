...
object ThirdParty {
  ...
  def finagleThrift(v: String) =
    if (v.startsWith("2.10")) finagleThrift210
  ...
  def parboiledScala(v: String) =
    if (v.startsWith("2.10")) parboiledScala210
