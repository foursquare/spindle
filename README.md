...
add the following line:
    ...
    addSbtPlugin("com.foursquare" % "spindle-codegen-plugin" % "1.8.2")
...
The latest release is 1.8.2. See the [changelog](https://github.com/foursquare/spindle/blob/master/CHANGELOG.md) for more details.
